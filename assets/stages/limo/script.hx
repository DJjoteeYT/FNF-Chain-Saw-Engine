...
function create()
{
	...
	bgLimo.frames = FlxAtlasFrames.fromSparrow(Paths.returnGraphic('stages/limo/images/bgLimo'),
		Paths.xml('stages/limo/images/bgLimo'));
	...
	for (i in 0...5)
	{
		...
		dancer.frames = FlxAtlasFrames.fromSparrow(Paths.returnGraphic('stages/limo/images/limoDancer'),
			Paths.xml('stages/limo/images/limoDancer'));
	...
	limo.frames = FlxAtlasFrames.fromSparrow(Paths.returnGraphic('stages/limo/images/limoDrive'),
		Paths.xml('stages/limo/images/limoDrive'));
	limo.animation.addByPrefix('drive', "Limo stage", 24);
	limo.animation.play('drive');
	limo.antialiasing = true;

	fastCar = new FlxSprite(-300, 160).loadGraphic(Paths.image('stages/limo/images/fastCarLol'));
	resetFastCar();
