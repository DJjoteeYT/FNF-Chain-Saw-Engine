...
function create()
{
	...
	bgSchool.setGraphicSize(Std.int(bgSky.width * PlayState.daPixelZoom));
	bgSchool.updateHitbox();
	bgSchool.scrollFactor.set(0.6, 0.90);
	PlayState.instance.add(bgSchool);

	var bgStreet:FlxSprite = new FlxSprite(-200).loadGraphic(Paths.returnGraphic('stages/school/images/weebStreet'));
	bgStreet.setGraphicSize(Std.int(bgSky.width * PlayState.daPixelZoom));
	bgStreet.updateHitbox();
	bgStreet.scrollFactor.set(0.95, 0.95);
	PlayState.instance.add(bgStreet);

	var fgTrees:FlxSprite = new FlxSprite(-30, 130).loadGraphic(Paths.returnGraphic('stages/school/images/weebTreesBack'));
	fgTrees.setGraphicSize(Std.int(Std.int(bgSky.width * PlayState.daPixelZoom) * 0.8));
	...
	bgTrees.setGraphicSize(Std.int(Std.int(bgSky.width * PlayState.daPixelZoom) * 1.4));
	...
	treeLeaves.setGraphicSize(Std.int(bgSky.width * PlayState.daPixelZoom));
